...
export class JohnCharacter extends Character implements Examine {
    ...
    public talk(choiceId?: number | undefined): ActionResult | undefined {
        ...
        if (choiceId === 1) {
            return new TextActionResult(["Player: I'm stuck in the cave! The darkness is overwhelming. I can hardly see a thing.",
            ...
            return new TextActionResult(["The spirit of John Jones: Seek the light, it will illuminate your path and lead you to safety."]);

        } else if (choiceId === 3) {
            return new TextActionResult(["The spirit of John Jones: Find something strong, like a rope, to help you climb out of this cave."]);


        } else if (choiceId === 4) {
            // Leegt de inventaris van de speler
            playerSession.inventory = [];
            return new TextActionResult(["Player: Yes, I found a rope!", "The spirit of John Jones: 'Excellent! With this rope, you may have a chance to escape this darkness.' "]);
        ...
        const ChoiceAction: TalkChoiceAction[] = [
            ...
            new TalkChoiceAction(6, "Back Story of The spirit of John Jones "),
        ...
        return new TalkActionResult(
            this,
            ["Player: Ahh! I just slid into the cave and now I'm stuck. The jagged rocks scrape against my skin, causing sharp pains to shoot through my body."],
            ChoiceAction
        );
    }
}
